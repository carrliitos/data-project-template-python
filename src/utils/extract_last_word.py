...
def extract_last_word(input_string):
  ...
  Returns:
  - str or None: The last word from the input string, or None if no word is 
  found.

  Example:
  >>> extract_last_word("C:\\Projects\\Routines\\routine_daily\\venv")
  'venv'
  >>> extract_last_word("C:\\Projects\\Routines\\routine_daily")
  'routine_daily'
  """
